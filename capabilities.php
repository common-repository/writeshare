			...
			switch ( $cap ):
				...
				case 'wpws_access_dashboard':
					if ( !is_user_logged_in() )
						return $_this->allow(); // Access to wp-admin is possible
				case 'wpws_see_admin_bar':
					$user = get_user_by( 'id', $user_id );
					if ( array_intersect( apply_filters( 'wpws_can_access_dashboard', array( 'administrator', 'editor' ) ), $user ? $user->roles : array( 'nobody' ) ) )
						return $_this->allow();
